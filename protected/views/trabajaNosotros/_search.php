...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'disponibilidad',array('size'=>50,'maxlength'=>50)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'area_interes'); ?>
		<?php echo $form->textField($model,'area_interes',array('size'=>50,'maxlength'=>50)); ?>
	</div>
